            ...
            <div class="row">
                <div class="col">
                    <div class="widget-about font-md mb-md-3 mb-lg-3 mb-xl-0 wow animate__animated animate__fadeInUp" data-wow-delay="0">
                        <div class="logo mb-30">
                            <a class='mb-15' href='index.php'><img src="assets/imgs/theme/logo.svg" alt="logo" /></a>
                ...
                <div class="footer-link-widget col wow animate__animated animate__fadeInUp" data-wow-delay=".1s>
                    ...
                    <ul class="footer-list mb-sm-5 mb-md-0">
                        ...
                        <li><a href="index.php#">Delivery Information</a></li>
                        <li><a href="index.php#">Privacy Policy</a></li>
                        <li><a href="index.php#">Terms &amp; Conditions</a></li>
                        <li><a href="index.php#">Contact Us</a></li>
                        <li><a href="index.php#">Support Center</a></li>
                ...
                <div class="footer-link-widget col wow animate__animated animate__fadeInUp" data-wow-delay=".2s">
                    ...
                    <ul class="footer-list mb-sm-5 mb-md-0">
                        ...
                        <li><a href="index.php#">Help Ticket</a></li>
                        <li><a href="index.php#">Shipping Details</a></li>
                        <li><a href="index.php#">Compare products</a></li>
                    </ul>
                </div>
                <div class="footer-link-widget col wow animate__animated animate__fadeInUp" data-wow-delay=".3s">
                    <h4 class="widget-title">Corporate</h4>
                    <ul class="footer-list mb-sm-5 mb-md-0">
                        <li><a href="index.php#">Become a Vendor</a></li>
                        <li><a href="index.php#">Affiliate Program</a></li>
                        <li><a href="index.php#">Farm Business</a></li>
                        <li><a href="index.php#">Farm Careers</a></li>
                        <li><a href="index.php#">Our Suppliers</a></li>
                ...
                <div class="footer-link-widget col wow animate__animated animate__fadeInUp" data-wow-delay=".4s">
                    ...
                    <ul class="footer-list mb-sm-5 mb-md-0">
                        <li><a href="index.php#">Milk & Flavoured Milk</a></li>
                        <li><a href="index.php#">Butter and Margarine</a></li>
                        <li><a href="index.php#">Eggs Substitutes</a></li>
                        <li><a href="index.php#">Marmalades</a></li>
                        <li><a href="index.php#">Sour Cream and Dips</a></li>
                        <li><a href="index.php#">Tea & Kombucha</a></li>
                        <li><a href="index.php#">Cheese</a></li>
                    </ul>
                </div>
                <div class="footer-link-widget widget-install-app col wow animate__animated animate__fadeInUp" data-wow-delay=".5s">
                    ...
                    <div class="download-app">
                        <a href="index.php#" class="hover-up mb-sm-2 mb-lg-0"><img class="active" src="assets/imgs/theme/app-store.jpg" alt="" /></a>
                        <a href="index.php#" class="hover-up mb-sm-2"><img src="assets/imgs/theme/google-play.jpg" alt="" /></a>
                    </div>
