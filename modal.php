            ...
            <div class="modal-body">
                <div class="deal" style="background-image: url('assets/imgs/banner/popup-1.png')">
                    ...
                    <div class="deal-content detail-info">
                        <h4 class="product-title"><a class='text-heading' href='shop-product-right.php'>Organic fruit for your family's health</a></h4>
                    ...
                    <div class="deal-bottom">
                        ...
                        <a class='btn hover-up' href='shop-grid-right.php'>Shop Now <i class="fi-rs-arrow-right"></i></a>
                    </div>
                </div>
            </div>
        </div>
