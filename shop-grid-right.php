                        ...
                        <div class="sort-by-product-area">
                            <div class="sort-by-cover mr-10">
                                ...
                                <div class="sort-by-dropdown">
                                    <ul>
                                        <li><a class="active" href="shop-grid-right.html#">50</a></li>
                            ...
                            <div class="sort-by-cover">
                                ...
                                <div class="sort-by-dropdown">
                                    <ul>
                                        <li><a class="active" href="shop-grid-right.html#">Featured</a></li>
                    ...
                    <div class="pagination-area mt-20 mb-20">
                        <nav aria-label="Page navigation example">
                            <ul class="pagination justify-content-start">
                                <li class="page-item">
                                    <a class="page-link" href="shop-grid-right.html#"><i class="fi-rs-arrow-small-left"></i></a>
                                </li>
                                <li class="page-item"><a class="page-link" href="shop-grid-right.html#">1</a></li>
                                <li class="page-item active"><a class="page-link" href="shop-grid-right.html#">2</a></li>
                                <li class="page-item"><a class="page-link" href="shop-grid-right.html#">3</a></li>
                                <li class="page-item"><a class="page-link dot" href="shop-grid-right.html#">...</a></li>
                                <li class="page-item"><a class="page-link" href="shop-grid-right.html#">6</a></li>
                                <li class="page-item">
                                    <a class="page-link" href="shop-grid-right.html#"><i class="fi-rs-arrow-small-right"></i></a>
                                </li>
                            </ul>
                        </nav>
                    </div>
